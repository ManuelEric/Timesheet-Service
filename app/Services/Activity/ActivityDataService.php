...
class ActivityDataService
{
    ...
    public function listActivitiesByTimesheetAndCutoff(Timesheet $timesheet, $cutoff_start, $cutoff_end)
    {
        /* fetch activities based on requested timesheet */
        $activities = $timesheet->activities();
        // return $activities->sortBy('asc')->map(function ($data) {
        return $activities->filterCutoff(['cutoff_start' => $cutoff_start, 'cutoff_end' => $cutoff_end])->orderBy('id', 'asc')->get()->map(function ($data) {
